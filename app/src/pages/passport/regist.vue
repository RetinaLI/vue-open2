      ...
      <div class="wrapper">
        ...
        <el-form :model="registForm" @keyup.enter.native="submitForm" status-icon :rules="rules" ref="registForm" label-width="72px" label-position="left" class="form">
          ...
          <el-form-item label="验证码：" prop="zk_captcha">
            <el-input v-model="registForm.zk_captcha" class="check-code" placeholder="请输入验证码" ></el-input>
          ...
          <el-checkbox v-model="registForm.check" id="read">我已经阅读并同意<a href="/passport/protocol/index.html" target="_blank"> &nbsp;服务条款</a> 和 <a href="/passport/protocol" target="_blank">隐私政策</a></el-checkbox>
          </el-form-item>
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        email: [
          { validator: ValidateFactory.email, required: true, trigger: 'blur' }
        ],
        check: [
